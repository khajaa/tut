...
##CakePHP - Download Data as a CSV File

###Step1

Add csv.php into views/helper
...
On the top, add Csv as a helper
```php
 ```
Then create a method "download"
    function download(){
...
In this example, I'm dumping all data from Order table.
